<div class="container">
    ...
    <section class="projects" id="projetos">
        ...
        <div class="projects_slides js-scroll">

            <?php if ( have_rows('portfolio_projects') ) : while( have_rows('portfolio_projects') ) : the_row(); ?>
            <div class="projects_slides_card">
                <div class="projects_slides_card_title-bar">
                ...
                <div class="projects_slides_card_footer">
                    <a href="<?php the_sub_field('portfolio_projects_url'); ?>" target="_blank" class="btn-transparent">Acessar projeto</a>
